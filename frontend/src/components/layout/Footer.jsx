      ...
      <div className="mx-auto max-w-7xl px-6 py-16 lg:px-10 lg:py-20">
        ...
        <div className="grid grid-cols-1 gap-12 border-b border-white/10 pb-14 lg:grid-cols-4 lg:gap-16">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="mt-5 max-w-sm text-[13.5px] leading-relaxed text-white/55">
              A premier beachfront retreat in Cebu — where pristine white sands,
              crystal-clear waters, and genuine Filipino hospitality create your
          ...
          {/* Explore */}
          <div>
            <h6 className="mb-6 text-[9px] font-semibold uppercase tracking-[0.4em] text-[#651D4C]">
              Explore
            </h6>
          ...
          <div>
            ...
            <p className="text-[13px] leading-relaxed text-white/55">
              Save up to 50% when you book direct. Best rate guaranteed — no
              third-party fees.
            </p>
            <Link
              to="/booking"
            ...
            <div className="mt-10">
              <h6 className="mb-3 text-[9px] font-semibold uppercase tracking-[0.4em] text-[#651D4C]">
                Admin
              </h6>
              <Link
                to="/owner/login"
        ...
        <div className="flex flex-col items-center justify-between gap-4 pt-10 sm:flex-row">
          ...
          <div className="flex items-center gap-5 text-[11px] uppercase tracking-[0.28em] text-white/25">
            ...
            <Link to="/contact" className="hover:text-white/60">
              Contact
            </Link>
            <span className="h-3 w-px bg-white/15" />
            <button
              ...
              className="group inline-flex items-center gap-2 hover:text-[#651D4C]"
