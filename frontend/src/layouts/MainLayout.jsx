...
/* WhatsApp floating button — appears only when admin sets a whatsapp number */
function WhatsAppButton({ number }) {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-24 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-2xl ring-4 ring-white/30 transition-transform hover:scale-110"
    >
...
export default function MainLayout() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <Navbar />
      <SideSocialBar email={social.email} facebookUrl={social.facebookUrl} />
      ...
      <PromoModal />
      <MobileBookingBar />
      <WhatsAppButton number={social.whatsapp || social.phone} />
    </div>
  );
}
